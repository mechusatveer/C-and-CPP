...
*/
 ...
 /*Trick 
   Two assignment operator we need here
   One will take string object and other const char*
   
   CopyOnWrite & operator=(const CopyOnWrite & obj);
   CopyOnWrite & operator=(const char* str); //This get called on CopyOnWrite
   and u need to allocate new buffer and copy this str there
...
{
  public:
  CopyOWString(const char* str)
  {
    newStr(str);
  }
  CopyOWString(CopyOWString& cowStr)
  {
    incRef(cowStr);
  }
  ~CopyOWString()
